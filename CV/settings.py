...
SECRET_KEY = 'django-insecure-)caqbq#k&sev(4)3t4y*-o1+pz=x=9$d+c%n+4(=1!6bm%asuk'
...
STATICFILES_DIRS = [  # Creamos una lista
    STATIC_DIR,  # Agregamos el path que creamos antes
]
